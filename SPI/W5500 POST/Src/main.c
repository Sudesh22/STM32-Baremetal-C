...
const char http_post_req[] =
    "POST / HTTP/1.1\r\n"
    "Host: 192.168.0.32\r\n"
    "User-Agent: STM32-W5500\r\n"
    "Content-Type: application/json\r\n"
    "Content-Length: 29\r\n"
    "Connection: close\r\n"
    "\r\n"
    "{\"param1\":10.0,\"param2\":20.0}";


uint16_t tx_free_size, tx_wr_ptr;
uint16_t post_len = strlen(http_post_req);
	...
	while(1){
		...
		if (control == 0x13){
			...
			if (control == 0x17){
				...
				W5500_Socket0_Write(offset, (uint8_t*)http_post_req, post_len);
